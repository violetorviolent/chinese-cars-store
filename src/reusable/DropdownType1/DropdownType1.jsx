...
const DropdownType1 = (props) => {
  ...
  return (
    <div className='DropdownType1' onClick={() => { setToggleOptions(!toggleOptions); handleRotate() }}>
          <div className='DropdownType1-dropdown '>
            <p>{props.title}</p>
          ...
          {toggleOptions &&
            <div className='DropdownType1-Options slide-down '>
              {props.list.map((card) => {
                return (
